...
import com.wangk.mymusic.Home.UI.Bean.Tracks;
import com.wangk.mymusic.R;

import java.util.List;

public class CoverPageAdapter extends BaseAdapter {
    private List<Tracks> mData;
    private Context mContext;

    public CoverPageAdapter(List<Tracks> mData, Context mContext) {
        this.mData = mData;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(mContext)
                .load(mData.get(position).getAl().getPicUrl())
