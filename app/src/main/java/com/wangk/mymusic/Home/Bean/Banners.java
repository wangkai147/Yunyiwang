...
public class Banners implements Serializable {
    ...
    public void setMonitorImpressList(List<String> monitorImpressList) {
    ...
    public void setMonitorClickList(List<String> monitorClickList) {
        this.monitorClickList = monitorClickList;
    }
    public List<String> getMonitorClickList() {
